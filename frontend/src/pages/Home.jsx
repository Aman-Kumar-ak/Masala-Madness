          ...
          <div className="bg-white shadow-lg rounded-full border border-orange-200 flex items-center justify-between gap-1 sm:gap-3 max-w-md w-full overflow-hidden">
            ...
            <div className="flex items-center gap-2 md:gap-3 flex-1 min-w-0 pl-3 sm:pl-4 py-2.5 sm:py-3">
              ...
              <div className="flex flex-col min-w-0 flex-1">
                ...
                <div className="flex items-center gap-1 overflow-hidden">
                  <span className="text-xs sm:text-sm text-gray-500 whitespace-nowrap">{cartItems.length} {cartItems.length === 1 ? 'item' : 'items'}</span>
                  {activeDiscount && subtotal < activeDiscount.minOrderAmount && (
                    <span className="text-xs text-orange-600 whitespace-nowrap overflow-hidden text-ellipsis max-w-[120px] sm:max-w-full">
